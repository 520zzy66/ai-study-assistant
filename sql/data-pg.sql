-- AI 学习助手初始化数据 (PostgreSQL)

-- 插入测试用户 (密码: 123456, BCrypt加密)
-- BCrypt hash for "123456" with strength=10
INSERT INTO app_user (username, password, nickname, email) VALUES
('testuser', '$2a$10$EqKcp1WFKVQIShMPC7B3kuznX9gAZMsVnSNjN0SHiXh1bXbLxKO3e', '测试用户', 'test@example.com'),
('test2', '$2a$10$EqKcp1WFKVQIShMPC7B3kuznX9gAZMsVnSNjN0SHiXh1bXbLxKO3e', '测试用户2', 'test2@example.com')
...
ON CONFLICT (user_id, source, original_name) DO NOTHING;
