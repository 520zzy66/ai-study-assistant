...
Codex 在执行任务时，可以参考对应 Prompt 的工作模式。
...
|------------------------|------------|------|
| "开始新任务"、"开始开发"、"新功能" | `start-task.md` | 先阅读 AGENTS.md + spec.md + task-list.md 再开始 |
...
2. 如果用户意图不在表中，不强行匹配 — 直接按 AGENTS.md 基础规则执行
